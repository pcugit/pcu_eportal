template = {
    ...
    'steps': [
        ...
        {'title': 'Direct Entry Qualifications', 'type': 'fields', 'fields': [
            {'name': 'qualification_type', 'type': 'select', 'label': 'Qualification Type', 'options': ['OND', 'HND', 'Other'], 'required': True},
            {'name': 'qualification_institution', 'type': 'text', 'label': 'Institution Name', 'required': True},
            {'name': 'qualification_year', 'type': 'number', 'label': 'Year Obtained', 'required': True},
        ]},
        ...
        {'title': 'Documents', 'type': 'documents', 'documents': [
            ...
            {'type': 'direct_entry_slip', 'label': 'Direct Entry Slip', 'required': True},
            {'type': 'qualification_certificate', 'label': 'Qualification Certificate (OND/HND)', 'required': True},
        ]},
    ]
}
