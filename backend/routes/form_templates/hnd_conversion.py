template = {
    'program': 'HND Direct Entry Conversion',
    'steps': [
        {
        ...
        {'title': 'HND Qualifications', 'type': 'fields', 'fields': [
            {'name': 'qualification_type', 'type': 'select', 'label': 'Qualification Type', 'options': ['HND', 'OND', 'Other'], 'required': True},
        ...
        {'title': 'Documents', 'type': 'documents', 'documents': [
            ...
            {'type': 'hnd_certificate', 'label': 'HND Certificate/Transcript', 'required': True},
        ]},
    ]
}
