    ...
    'steps': [
        ...
        },
        {
            ...
            'fields': [
                ...
                {'name': 'mode_of_entry', 'type': 'select', 'label': 'Mode of Entry', 'options': ['UTME', 'Direct Entry', 'Transfer', 'Others'], 'required': True},
                {'name': 'choice1', 'type': 'text', 'label': 'First Choice', 'required': True},
                {'name': 'choice2', 'type': 'text', 'label': 'Second Choice', 'required': True},
                {'name': 'utme_subject1', 'type': 'text', 'label': 'JAMB Subject 1', 'required': True},
                {'name': 'utme_score1', 'type': 'number', 'label': 'JAMB Score 1', 'required': True},
                {'name': 'utme_subject2', 'type': 'text', 'label': 'JAMB Subject 2', 'required': True},
                {'name': 'utme_score2', 'type': 'number', 'label': 'JAMB Score 2', 'required': True},
                {'name': 'utme_subject3', 'type': 'text', 'label': 'JAMB Subject 3', 'required': True},
                {'name': 'utme_score3', 'type': 'number', 'label': 'JAMB Score 3', 'required': True},
                {'name': 'utme_subject4', 'type': 'text', 'label': 'JAMB Subject 4', 'required': True},
        ...
        {'title': 'Documents', 'type': 'documents', 'documents': [
            ...
            {'type': 'jamb_result', 'label': 'JAMB Result Slip', 'required': True},
        ]},
    ]
}
